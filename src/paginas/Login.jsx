...
const Login = () => {
  ...
  //Recuerda que se manda a llamar con llaves
  const {setAuth} = useAuth()
  

  //Dejare los ejemplos del usAuth
  // const { auth } = useAuth();
  // console.log(auth)
  //Solo un ejemplo

  //useNavigate de react-router-dom lo utilizamos para llevar el usuario por la navegación
  ...
  const handleSubmit = async e => {
    ...
    try {
      //El post devuelve un objeto con el token
